...
# requests start from user
def get_start():
  start_point_letter = input("Where are you coming from? Type in the corresponding letter: ")
  if start_point_letter in landmark_string:
...
# requests destination from user
def get_end():
  end_point_letter = input("Ok, where are you headed? Type in the corresponding letter: ")
  if end_point_letter in landmark_string:
...
def get_route(start_point, end_point):
  ...
  # to store alternative station_routes between landmarks
  routes = []
...
stations_under_construction = ['Aberdeen','Bridgeport', 'Yaletown-Roundhouse', 'Waterfront']
...
### TESTS
# testing get_route()
# print(get_route(landmark_choices["a"],landmark_choices["v"]))

# # testing new_route
# new_route("a","v")

# # testing get_active_stations()
